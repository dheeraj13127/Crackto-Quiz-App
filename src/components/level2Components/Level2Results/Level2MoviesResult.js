...
function Level2MoviesResult() {
  ...
  const claimCracks=()=>{
    localStorage.setItem('pbv2',75)
    if(score==7){
      localStorage.setItem('cracks',350)
    }
        ...
        <div className="col s12 l12 ">
          <div className="col s12 l12 level1CricResultContainerCard">
            ...
            <div className="center-align" style={{marginTop:"35px"}}>
              {score==7?<div><i className="far fa-laugh-beam level1HappyEmoji"></i><p className="white-text">Wow ! you have successfully cracked Chapter 2</p></div>:<div><i className="far fa-frown level1SadEmoji"></i><p className="white-text">Better luck next time</p></div>}
            ...
            {score==7?<div className="center-align" style={{marginTop:"40px"}}><a onClick={proceedToChapter2} href="" className="btn-small yellow darken-3">Unlock Chapter 2</a></div>:<div className="center-align" style={{marginTop:"40px"}}><a onClick={retryLevel} href="" className="btn-small yellow darken-3">Retry Chapter 2</a></div>}
...
export default Level2MoviesResult
