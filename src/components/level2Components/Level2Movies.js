...
import {levelMoviesQuestions} from '../level2Components/Level2QuestionBank/levelMoviesQuestions'
import steppen from '../../media/steppen.jpeg'
import wonder from '../../media/wonderwoman.mp3'
import { QuizContext } from '../helpers/Contexts'
import {useHistory} from 'react-router-dom'
import '../../App.css'
import ReactAudioPlayer from 'react-audio-player';
import Navbar from '../dashBoardComponent/Navbar'
function Level2Movies() {
  const M=window.M
  ...
  const checkScore=()=>{
    ...
    history.push('/level2/2/result')
  }
  return (
    <div>
      <Navbar/>
      <div className="container level2MoviesContainer">
      <div className="row">
        <div className="col s12 l12">
          ...
          <div className="col s12 l12 hoverable">
            <div className="col s12 l12 level1CricCardGlass">
              ...
              {currQues===4&&<div className="center-align"><img src={steppen} alt="" className="responsive-img" style={{width:"120px",height:"120px",border:"2px solid white",borderRadius:"5px"}}/></div>}
              {currQues===6&&<div className="center-align col s12 l12"><audio controls autoPlay style={{width:"150px"}}> <source src={wonder} type="audio/mpeg"/></audio></div>}
