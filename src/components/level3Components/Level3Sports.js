...
import {levelSportsQuestions} from '../level3Components/Level3QuestionBank/LevelSportsQuestions'
import dk from '../../media/dk.jpg'
import shara from '../../media/sharapova.jpg'
import { QuizContext } from '../helpers/Contexts'
import {useHistory} from 'react-router-dom'
import '../../App.css'
import Navbar from '../dashBoardComponent/Navbar'
function Level3Sports() {
  const M=window.M
  ...
  return (
    <div>
      <Navbar/>
      <div className="container level3SportsContainer">
      <div className="row">
        <div className="col s12 l12">
          ...
          <div className="col s12 l12 hoverable">
            <div className="col s12 l12 level1CricCardGlass">
              ...
              {currQues===4&&<div className="center-align"><img src={dk} alt="" className="responsive-img" style={{width:"120px",height:"120px",border:"2px solid white",borderRadius:"5px"}}/></div>}
              {currQues===7&&<div className="center-align"><img src={shara} alt="" className="responsive-img" style={{width:"120px",height:"120px",border:"2px solid white",borderRadius:"5px"}}/></div>}
