...
function Level3TechResult() {
  ...
  const claimCracks=()=>{
    localStorage.setItem('pbv3',100)
    if(score==10){
      localStorage.setItem('cracks',900)
    }
  ...
  const retryLevel=()=>{
    ...
    setScore(0)
    history.push('/level3/3')
  }
  const proceedToChapter2=()=>{
    if(cracksClaimed=="true"){
      localStorage.setItem("level1Score",0)
    setScore(0)
      localStorage.setItem('Level3Inc',4)
        ...
        <div className="col s12 l12 ">
          <div className="col s12 l12 level1CricResultContainerCard">
            ...
            <div className="center-align" style={{marginTop:"35px"}}>
              {score==10?<div><i className="far fa-laugh-beam level1HappyEmoji"></i><p className="white-text">Wow ! you have successfully cracked Chapter 3</p></div>:<div><i className="far fa-frown level1SadEmoji"></i><p className="white-text">Better luck next time</p></div>}
            ...
            {score==10?<div className="center-align" style={{marginTop:"40px"}}><a onClick={proceedToChapter2} href="" className="btn-small yellow darken-3">Proceed</a></div>:<div className="center-align" style={{marginTop:"40px"}}><a onClick={retryLevel} href="" className="btn-small yellow darken-3">Retry Chapter 3</a></div>}
...
export default Level3TechResult
